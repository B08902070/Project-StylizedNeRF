...
class Style_MLP(nn.Module):
    def __init__(self, W=8, D=256, input_ch_pts=3, input_ch_viewdir=3, skips=[4],
...
class Style_NeRF(nn.Module):
    def __init__(self, args, mode='coarse', enable_style=False):
        ...
        self.net = Style_MLP(W=self.netwidth, D=self.netdepth, input_ch_pts=self.input_ch_pts, input_ch_viewdir=self.input_ch_viewdir,
